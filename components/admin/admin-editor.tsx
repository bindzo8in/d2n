...
import { ImageBubbleMenu } from "@/components/admin/image-bubble-menu";
...
// Cloudinary upload handler for Tiptap
...
export function AdminEditor({ value, onChange }: AdminEditorProps) {
  ...
  useEffect(() => {
    if (editor && editor.getHTML() !== value) {
      // Small optimization to prevent cursor jumping when updating value from outside
      if (!editor.isFocused) {
  ...
  return (
    <div className="simple-editor-wrapper relative border rounded-md" style={{ width: '100%', height: 'auto', minHeight: '500px', overflow: 'hidden' }}>
